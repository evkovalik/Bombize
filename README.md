...
Данные передаются в бинарном формате. В качестве БД используется MySQL.

Для передачи по UDP реализована возможность гарантированной доставки пакетов в исходном порядке.\
Для плавности при синхронизации позиций игроков используется интерполяции на стороне клиента.
